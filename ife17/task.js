...
function getDateStr(dat) {
  ...
  var aqiSourceData = {
    ...
    "Stockholm": randomBuildData(300),
    "Gothenburg": randomBuildData(200),
    "Paris": randomBuildData(100),
    "ShangHai": randomBuildData(300),
    "London": randomBuildData(500),
    "Tokyo": randomBuildData(100),
    "New York": randomBuildData(100),
    "Berlin": randomBuildData(500)
  };
